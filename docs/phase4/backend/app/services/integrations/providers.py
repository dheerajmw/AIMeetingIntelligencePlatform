...
def send_summary_email(meeting_title: str, summary: str, action_items: list[dict[str, Any]]) -> str:
    import smtplib
    ...
    _require(
        ...
        settings.smtp_from,
        settings.smtp_to,
        names=["SMTP_HOST", "SMTP_FROM", "SMTP_TO"],
    )
    ...
    return f"email_sent:{settings.smtp_to}"
